...
class TestGeneralDataSourcePlugin:
    ...
    def test_get_departments(self, general_ds_cfg, logger, context):
        plugin = GeneralDataSourcePlugin(general_ds_cfg, logger, context)
    ...
    def test_get_users(self, general_ds_cfg, logger, context):
        plugin = GeneralDataSourcePlugin(general_ds_cfg, logger, context)
    ...
    def test_test_connection(self, general_ds_cfg, logger, context):
        result = GeneralDataSourcePlugin(general_ds_cfg, logger, context).test_connection()
    ...
    @mock.patch("bkuser.plugins.general.plugin.fetch_first_item", new=_mocked_fetch_first_item)
    def test_test_connection_with_simple_users(self, general_ds_cfg, logger, context):
        """API 返回的字段不足，无法完全解析"""
    ...
    @mock.patch("bkuser.plugins.general.plugin.fetch_first_item", new=_mocked_fetch_first_item)
    def test_test_connection_without_data(self, general_ds_cfg, logger, context):
