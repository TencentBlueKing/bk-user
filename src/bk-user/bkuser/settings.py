...
# 限制搜索结果是否展示协同租户用户 or 部门
ENABLE_SEARCH_COLLABORATION_TENANT = env.bool("ENABLE_SEARCH_COLLABORATION_TENANT", True)
# 限制搜索结果是否展示虚拟用户
ENABLE_SEARCH_VIRTUAL_USER = env.bool("ENABLE_SEARCH_VIRTUAL_USER", True)
