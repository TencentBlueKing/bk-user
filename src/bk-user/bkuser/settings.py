...
# 限制人员选择器是否展示协同租户用户 or 部门
ENABLE_DISPLAY_COLLABORATION_TENANT = env.bool("ENABLE_DISPLAY_COLLABORATION_TENANT", True)
# 限制人员选择器是否展示虚拟用户
ENABLE_DISPLAY_VIRTUAL_USER = env.bool("ENABLE_DISPLAY_VIRTUAL_USER", True)
