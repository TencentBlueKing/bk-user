...
# 默认内置管理员密码有效期，单位为天
DEFAULT_BUILTIN_MANAGEMENT_PASSWORD_VALID_TIME = env.int("DEFAULT_BUILTIN_MANAGEMENT_PASSWORD_VALID_TIME", 7)
# 默认内置管理员登录地址过期时间，单位为天
DEFAULT_BUILTIN_MANAGEMENT_LOGIN_URL_VALID_TIME = env.int("DEFAULT_BUILTIN_MANAGEMENT_LOGIN_URL_VALID_TIME", 7)
