...
from bkuser.plugins.ldap.models import ServerConfig
...
class LDAPClient:
    ...
    def fetch_first_object(self, search_filter: str, object_class: str) -> Dict:
    ...
    def _fetch_objects_with_page(self, search_filter: str, object_class: str, page_size: int) -> List[Dict]:
        if page_size <= 0:
        ...
        return [{"dn": r["dn"], "attributes": r["attributes"]} for r in results]
