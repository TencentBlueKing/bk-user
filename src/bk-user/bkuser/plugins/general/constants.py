...
STATUS_CODE_REASON_MAP = {
    400: _("请求参数有误，请确保您的 API 路径与参数符合 API 文档的要求"),
    401: _("未授权请求或身份验证失败，请检查您的认证配置下的认证凭据"),
    403: _("请求被拒绝或没有权限访问，请确保您拥有访问相关资源的权限"),
    404: _("请求的资源未找到，请确保您的服务地址与 API 路径拼写正确"),
    405: _("请求方法不被允许，请检查您的服务地址与 API 路径并确保服务支持该请求"),
    429: _("请求过于频繁，请稍后再试"),
    500: _("服务器内部遇到未知错误，请通过服务端日志排查问题原因"),
    501: _("服务器不支持请求的功能，请确保请求的功能已经实现"),
    502: _("服务器从上游服务器接收到无效响应，请检查上游服务器是否运行正常以及返回的内容是否正确"),
    503: _("服务器暂时过载或维护，当前无法处理请求，请检查服务器资源使用情况并稍后重试"),
    504: _("服务器未能及时从上游服务器收到响应，请确保上游服务器是否正常运行"),
}
