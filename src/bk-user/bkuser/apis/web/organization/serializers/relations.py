...
class TenantDeptUserRelationBatchPatchInputSLZ(TenantDeptUserRelationBatchCreateInputSLZ):
    ...
    def validate(self, attrs: Dict[str, Any]) -> Dict[str, Any]:
        ...
        _validate_tenant_department_ids(
            [attrs["source_department_id"]], self.context["tenant_id"], self.context["data_source_id"]
        )
        return attrs
...
class TenantDeptUserRelationBatchDeleteInputSLZ(serializers.Serializer):
    ...
    def validate(self, attrs: Dict[str, Any]) -> Dict[str, Any]:
        data_source_id = self.context["data_source_id"]
        _validate_tenant_user_ids(attrs["user_ids"], self.context["tenant_id"], data_source_id)
        _validate_tenant_department_ids([attrs["source_department_id"]], self.context["tenant_id"], data_source_id)
