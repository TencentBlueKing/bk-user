...
from bkuser.apis.open_v3.permissions import ApiGatewayAppVerifiedPermission
from bkuser.apps.data_source.constants import DataSourceTypeEnum
from bkuser.apps.data_source.models import DataSource


class ProviderApiCommonMixin:
    """数据提供方 API 公共 Mixin"""
    ...
    def data_source(self) -> DataSource:
        ...
        if not data_source:
            raise ValidationError("data source not found or not belongs to this tenant")
        return data_source
