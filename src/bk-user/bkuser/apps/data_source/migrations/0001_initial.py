    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name_zh_cn', models.CharField(max_length=128, null=True, unique=True, verbose_name='数据源插件名称')),
                ('name_en_us', models.CharField(max_length=128, null=True, unique=True, verbose_name='数据源插件名称')),
