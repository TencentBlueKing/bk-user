...
from bkuser.apps.data_source.constants import DataSourceStatus, TenantUserIdRule
...
class DataSource(AuditedModel):
    ...
    domain = models.CharField("所属租户域名", max_length=128, default="")
    owner_tenant_user_id_rule = models.CharField(
        "归属租户用户 ID 生成规则",
        max_length=64,
        choices=TenantUserIdRule.get_choices(),
        default=TenantUserIdRule.UUID4_HEX.value,
    )
