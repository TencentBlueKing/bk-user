...
class GlobalSettingsMetaApi(object):
    ...
    def v2_global_settings_meta_list(self, **kwargs):  # noqa: E501
        """v2_global_settings_meta_list  # noqa: E501

        获取对象列表  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v2_global_settings_meta_list(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.v2_global_settings_meta_list_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.v2_global_settings_meta_list_with_http_info(**kwargs)  # noqa: E501
            return data

    def v2_global_settings_meta_list_with_http_info(self, **kwargs):  # noqa: E501
        """v2_global_settings_meta_list  # noqa: E501

        获取对象列表  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v2_global_settings_meta_list_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method v2_global_settings_meta_list" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('lookup_field' in params and
            ...
            raise ValueError("Invalid value for parameter `lookup_field` when calling `v2_global_settings_meta_list`, length must be greater than or equal to `1`")  # noqa: E501
        if ('wildcard_search' in params and
                len(params['wildcard_search']) < 1):
            raise ValueError("Invalid value for parameter `wildcard_search` when calling `v2_global_settings_meta_list`, length must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            '/api/v2/global_settings_meta/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
