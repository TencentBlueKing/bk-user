...
class BatchApi(object):
    ...
    def v2_batch_profiles_delete_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params["kwargs"]):
            if key not in all_params:
                raise TypeError("Got an unexpected keyword argument '%s'" " to method v2_batch_profiles_delete" % key)
            params[key] = val
        del params["kwargs"]
        # verify the required parameter 'body' is set
        if "body" not in params or params["body"] is None:
            raise ValueError(
                "Missing the required parameter `body` when calling `v2_batch_profiles_delete`"
            )  # noqa: E501
    ...
    def v2_batch_profiles_partial_update_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params["kwargs"]):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'" " to method v2_batch_profiles_partial_update" % key
                )
            params[key] = val
        del params["kwargs"]
        # verify the required parameter 'body' is set
        if "body" not in params or params["body"] is None:
            raise ValueError(
                "Missing the required parameter `body` when calling `v2_batch_profiles_partial_update`"
            )  # noqa: E501
    ...
    def v2_batch_profiles_read_with_http_info(self, query_ids, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params["kwargs"]):
            if key not in all_params:
                raise TypeError("Got an unexpected keyword argument '%s'" " to method v2_batch_profiles_read" % key)
            params[key] = val
        del params["kwargs"]
        # verify the required parameter 'query_ids' is set
        if "query_ids" not in params or params["query_ids"] is None:
            raise ValueError(
                "Missing the required parameter `query_ids` when calling `v2_batch_profiles_read`"
            )  # noqa: E501
