...
class SyncTaskApi(object):
    ...
    def v2_sync_task_list(self, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            return self.v2_sync_task_list_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.v2_sync_task_list_with_http_info(**kwargs)  # noqa: E501
            return data
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method v2_sync_task_list" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def v2_sync_task_show_logs_with_http_info(self, lookup_value, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[SyncTaskProcess]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
