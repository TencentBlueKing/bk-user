...
class Profile(object):
    ...
    def staff_status(self, staff_status):
        ...
        if staff_status not in allowed_values:
            raise ValueError(
                "Invalid value for `staff_status` ({0}), must be one of {1}".format(  # noqa: E501
                    staff_status, allowed_values
                )
            )
    ...
    def time_zone(self, time_zone):
        ...
        if time_zone not in allowed_values:
            raise ValueError(
                "Invalid value for `time_zone` ({0}), must be one of {1}".format(  # noqa: E501
                    time_zone, allowed_values
                )
            )
