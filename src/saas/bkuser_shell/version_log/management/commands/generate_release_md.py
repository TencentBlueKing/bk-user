...
{% if change_log.project != '__Global__' %}
### {{ change_log.project }}
{% endif %}
{% for detail in change_log.detail %}{% for item in detail.content %}
- [{{ detail.type }}] {{ item }}{% endfor %}{% endfor %}
{% endfor %}
{% endfor %}
"""  # noqa
)
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        print(MD_TMPL.render(Context(version_list.dict())))
