...
| results | []V2CategoriesListOKBodyResultsItems0| 是 |  |  |



**V2CategoriesListOKBodyResultsItems0**
...
| enabled | boolean|  |  |  |
| id | integer|  |  |  |
| last_synced_time | date-time (formatted string)|  |  |  |
| order | integer|  |  |  |
| status | string|  |  |  |
| syncing | boolean|  |  |  |
| type | string| 是 |  |  |
| unfilled_namespaces | []string|  |  |  |
