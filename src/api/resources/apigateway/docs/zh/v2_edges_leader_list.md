...
| results | []V2EdgesLeaderListOKBodyResultsItems0| 是 |  |  |



**V2EdgesLeaderListOKBodyResultsItems0**
...
| 名称 | 类型 | 必选 | 描述 | 示例 |
|------|------|:--------:|-------------|---------|
| from_profile_id | integer| 是 |  |  |
| id | integer| 是 |  |  |
| to_profile_id | integer| 是 |  |  |