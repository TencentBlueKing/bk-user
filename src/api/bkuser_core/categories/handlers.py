...
def create_creator_actions(sender, instance, **kwargs):
    ...
    try:
        ...
        logger.exception("failed to create resource_creator_action (category related). [creator=%s, instance=%s]",
                        kwargs["creator"], instance)
    ...
    try:
        ...
        logger.exception("failed to create resource_creator_action (department related). [creator=%s, instance=%s]",
                        kwargs["creator"], instance)
