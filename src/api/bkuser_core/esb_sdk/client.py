...
class BaseComponentClient:
    ...
    def __init__(
        ...
        """
        self.app_code = bk_app_code or app_code or conf.APP_ID
        self.app_secret = bk_app_secret or app_secret or conf.APP_TOKEN
...
if conf.CLIENT_ENABLE_SIGNATURE:
    ComponentClient: Type[BaseComponentClient] = ComponentClientWithSignature
else:
