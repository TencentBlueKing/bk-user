...
export default {
  ...
  '确认要永久删除当前用户？': 'Are you sure you want to permanently delete the current user?',
  用户还原预览: 'User restore preview',
  ...
  '确认要永久删除当前组织？': 'Are you sure you want to permanently delete the current organization?',
  ...
  '确认要永久删除当前目录？': 'Are you sure you want to permanently delete the current directory?',
  目录还原预览: 'Directory restore preview',
  组织数: 'Tissue number',
  搜索目录名: 'Search directory name',
  一键移除错误项: 'Remove error items with one click',
  共: 'total',
  个用户: 'users',
  '可还原，': 'Reducible,',
  校验错误: 'Check error',
