...
export default {
  ...
  登录账户: 'Login account',
  点击确定后将跳到蓝鲸登录页面: 'Click ok to jump to the BlueKing login page',
  更多操作: 'More',
  // 设置
  ...
  重置: 'Reset',
  回收策略保存成功: 'The recycle policy is saved successfully.',
  回收策略重置成功: 'The recycle policy is reset successfully.',
  '30天': '30 days',
  '90天': '90 days',
  '180天': '180 days',
  '1年': '1 year',
  ...
  新建目录: 'New directory',
  目录配置未完成: 'The directory configuration is incomplete',
