...
export default {
  ...
  actions: {
    ...
    ajaxGetUpdateDetailRecord(_context, params, config = {}) {
      const url = `/api/v1/web/sync_tasks/${params.id}/progresses`;
      return http.get(url, config);
    },

    // 获取新增目录类型数据
    ajaxGetCatalogMetas(_context, _params, config = {}) {
      const url = 'api/v1/web/categories/metas/';
      return http.get(url, config);
    },

    // 获取用户目录列表
    ajaxGetCatalogList(_context, _params, config = {}) {
      const url = 'api/v1/web/categories/';
      return http.get(url, config);
    ...
    ajaxSyncCatalog(_context, params, _config = {}) {
      return http.post(`api/v1/web/categories/${params.id}/operations/sync_or_import/`);
    ...
    ajaxDeleteCatalog(_context, params, config = {}) {
      const url = `api/v1/web/categories/${params.id}/`;
    ...
    ajaxPostPassport(_context, params, config = {}) {
      const url = `api/v1/web/categories/${params.id}/settings/namespaces/password/`;
    ...
    ajaxGetDefaultPassport(_context, _params, config = {}) {
      const url = 'api/v1/web/settings/metas/?category_type=local&namespace=password';
      return http.get(url, config);
    ...
    ajaxPostConnection(_context, params, config = {}) {
      const url = `api/v1/web/categories/${params.id}/settings/namespaces/connection/`;
      return http.post(url, params.data, config);
      // return http.get(`?mock-file=catalog`, config)
    },
    ...
    ajaxGetDefaultConnection(_context, _params, config = {}) {
      const url = 'api/v1/web/settings/metas/?category_type=mad&namespace=connection';
      return http.get(url, config);
    ...
    ajaxPostFields(_context, params, config = {}) {
      const url = `api/v1/web/categories/${params.id}/settings/namespaces/fields/`;
      return http.post(url, params.data, config);
      // return http.get(`?mock-file=catalog`, config)
    },
    ...
    ajaxGetDefaultFields(_context, params, config = {}) {
      const url = `api/v1/web/settings/metas/?category_type=${params.type}&namespace=fields`;
      return http.get(url, config);
    ...
    ajaxGetAccount(_context, params, config = {}) {
      const url = `api/v1/web/categories/${params.id}/settings/namespaces/account/`;
      return http.get(url, config);
    },
