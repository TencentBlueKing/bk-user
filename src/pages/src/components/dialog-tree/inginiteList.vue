    ...
    <div class="render-wrapper" ref="content">
      <div class="organization-content">
        <div
          ...
          :key="item.id"
          :class="['organization-item', { focus: index === organizationIndex || item.selected },
      ...
      <div class="user-content">
        <div
          ...
          :key="item.id"
          :class="['user-item', { focus: index === userIndex || item.selected },
                   { 'is-disabled': item.disabled || isDisabled }]"
  ...
  methods: {
    ...
    setCheckStatusByIndex() {
      if (this.organizationIndex !== -1) {
        const currentOrganizationItem = this.renderOrganizationList
          .find((item, index) => index === this.organizationIndex);
