  ...
  <div class="grid place-items-center">
    ...
    <transition>
      <div class="filter-operation-history-container" v-if="!isFold">
        <bk-form class="w-full mt-[24px]" form-type="vertical">
    ...
    <div class="flex justify-center w-full">
      <div @mouseover="handleHoverFoldBtn" @mouseleave="handleLeaveFoldBtn" v-if="!isFold">
        <bk-button
          ...
          @click="toggleFold"
          class="w-[120px] h-[24px] text-bold border-none">︿</bk-button>
        <bk-button
          v-else
          @click="toggleFold"
          class="w-[120px] h-[24px] !bg-[#DCDEE5] !text-[#ffffff] text-bold border-none">︿</bk-button>
      </div>
      <div v-else>
        <bk-button
          theme="primary"
