<template>
  <div class="protocol-pop">
    <div class="protocol-detail">
      <span class="del-text close" @click="handleClose"><close-line class="icon-close" /></span>
      <div class="detail-content">
        ...
        <div class="detail-list">
          ...
          <p>7.1 【帐号使用规范】</p>
          <p>7.1.1 用户有责任妥善保管注册账户信息及账户密码的安全，用户需要对注册账户以及密码下的行为承担法律责任。用户同意在任何情况下不向他人透露账户及密码信息。在您怀疑他人在使用您的帐号时，请您及时处理。</p>
      ...
      <div class="consent-content">
        <button class="consent-btn" @click="handleClose">已阅读</button>
      </div>
    </div>
  </div>
</template>
